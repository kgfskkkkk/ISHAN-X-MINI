...
case 'down_1080': {
    try {
        const qualityMap = { down_360: '360p', down_480: '480p', down_720: '720p', down_1080: '1080p' };
        const quality = qualityMap[command] || '360p';
        ...
        try {
            ...
            console.error('API failed (video):', e1.message);
        }
...
case 'down_1080d': {
    try {
        ...
        const qualityMap = { down_360d: '360p', down_480d: '480p', down_720d: '720p', down_1080d: '1080p' };
        const quality = qualityMap[command] || '360p';
        ...
        try {
            ...
            console.error('API failed (doc):', e1.message);
        }
