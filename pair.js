...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰'; // Default name fallback
...
case 'alive': {
  try {
    ...
    const botName = cfg.botName || '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰'; // Default fancy name
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰';
...
case 'ashiya': {
  try {
    ...
    const botName = '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰';
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '𝙸𝚂𝙷𝙰𝙽-𝐗𝐌𝐃 4.0.0𝗩 🥷🇱🇰'; // dynamic bot name
