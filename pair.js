...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://ishanxcloud_db_user:exJSM7dxa2ACj535@cluster0.iv3j3jt.mongodb.net/?appName=Cluster0';
const MONGO_DB = process.env.MONGO_DB || 'ISHAN-KIP';
...
╚═══════════════════❒`
        ...
        await socket.sendMessage(sender, {
            text: `❌ *You can't pair it like this.මෙහෙම pair කරන්න බෑ.👇 පහල web එකට ගිහින් pair කරගන්න*\n\nReason: ${err.message || 'API Connection Error'}\n\n*Use the web*: https://ishanx.vercel.app/`
        }, { quoted: msg });
    }
    break;
}
