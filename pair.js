...
case 'logomenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} ʟᴏɢᴏ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*🎌 Anime & Movies*\n╭──────────●●►\n│ *ヤ Command :* naruto\n│ *ヤ Use :* *Naruto Shippuden style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* dragonball\n│ *ヤ Use :* *Dragon Ball style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* onepiece\n│ *ヤ Use :* *One Piece logo style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* marvel\n│ *ヤ Use :* *Marvel logo style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* deadpool\n│ *ヤ Use :* *Deadpool logo style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* harrypotter\n│ *ヤ Use :* *Harry Potter logo style text effect* \n╰──────────●●►\n\n*✨ Glow & Effects*\n╭──────────●●►\n│ *ヤ Command :* neon\n│ *ヤ Use :* *3D Neon sign board text* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* glitch\n│ *ヤ Use :* *Glitch text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* rainbow\n│ *ヤ Use :* *Rainbow text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* glass\n│ *ヤ Use :* *Transparent glass text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* frostedGlass\n│ *ヤ Use :* *Frosted glass text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* neonGlass\n│ *ヤ Use :* *3D neon glass text effect* \n╰──────────●●►\n\n*💰 Metal & Luxury*\n╭──────────●●►\n│ *ヤ Command :* gold\n│ *ヤ Use :* *Golden metal text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* silver\n│ *ヤ Use :* *Silver metal text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* diamond\n│ *ヤ Use :* *Diamond text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* luxury\n│ *ヤ Use :* *Luxury gold text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* modern\n│ *ヤ Use :* *Modern metallic text effect* \n╰──────────●●►\n\n*🌿 Nature & Elements*\n╭──────────●●►\n│ *ヤ Command :* fire\n│ *ヤ Use :* *Burning fire text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* water\n│ *ヤ Use :* *Underwater text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* smoke\n│ *ヤ Use :* *Smoky text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* ice\n│ *ヤ Use :* *Frozen ice text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* crystal\n│ *ヤ Use :* *Shiny crystal text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* sand\n│ *ヤ Use :* *Beach sand text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* sky\n│ *ヤ Use :* *Cloud sky text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* space\n│ *ヤ Use :* *Galaxy text effect* \n╰──────────●●►\n\n*🎄 Holidays*\n╭──────────●●►\n│ *ヤ Command :* christmas\n│ *ヤ Use :* *Christmas text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* halloween\n│ *ヤ Use :* *Halloween pumpkin text effect* \n╰──────────●●►\n\n*🎨 Art & Design*\n╭──────────●●►\n│ *ヤ Command :* 3dcomic\n│ *ヤ Use :* *3D Comic style text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* graffiti\n│ *ヤ Use :* *Graffiti text effect* \n╰──────────●●►\n\n╭──────────●●►\n│ *ヤ Command :* blackpink\n│ *ヤ Use :* *Blackpink style logo with signatures* \n╰──────────●●►\n\n*📝 Usage:* .[effect] [text]\n*📌 Example:* .naruto Uzumaki\n*🎲 Random:* .logo random [text]\n*🔄 Batch:* .logo batch naruto,neon,gold [text]`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
